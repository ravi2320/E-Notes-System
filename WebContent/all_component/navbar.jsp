	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item"><a class="nav-link" href="showNotes.jsp"><i
					class="fa fa-address-book" aria-hidden="true"></i></i>Show Notes</a></li>
		</ul>

		<%
		UserDetails user = (UserDetails) session.getAttribute("curr-user");
		...
		<a href="" class="btn btn-light my-2 my-sm-0 mr-2" data-toggle="modal"
			...
			class="fa fa-user-circle" aria-hidden="true"></i><%=user.getName()%></a> <a
		...
		<a href="login.jsp" class="btn btn-light my-2 my-sm-0 mr-2"
			type="submit"><i class="fa fa-user-plus" aria-hidden="true"></i>Login</a>
		<a href="register.jsp" class="btn btn-light my-2 my-sm-0"
			type="submit"><i class="fa fa-user-circle" aria-hidden="true"></i>Register
		</a>
